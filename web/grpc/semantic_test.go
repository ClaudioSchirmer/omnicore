...
func TestCodeFromNotificationsTable(t *testing.T) {
	cases := map[domain.NotificationSemantic]connect.Code{
		...
		domain.SemanticPaymentRequired:             connect.CodePermissionDenied,
		domain.SemanticNotAcceptable:               connect.CodeInvalidArgument,
		domain.SemanticRangeNotSatisfiable:         connect.CodeOutOfRange,
		domain.SemanticLocked:                      connect.CodeAborted,
		domain.SemanticPreconditionRequired:        connect.CodeFailedPrecondition,
		domain.SemanticUnavailableForLegalReasons:  connect.CodePermissionDenied,
		domain.SemanticInsufficientStorage:         connect.CodeResourceExhausted,
		domain.SemanticRequestHeaderFieldsTooLarge: connect.CodeResourceExhausted,
	}
