...
| Schema evolution | Declarative `Version(N)`, drift detection, advisory-lock rebuild | [mongo-schema-evolution](https://claudioschirmer.github.io/omnicore/#mongo-schema-evolution) |
