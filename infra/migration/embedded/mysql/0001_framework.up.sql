...
CREATE TABLE audit_events (
    ...
    thread_id     CHAR(36)     NOT NULL COMMENT 'Request id (AppContext.ID) tying the row to logs/traces.',
...
CREATE TABLE integration_events (
    ...
    correlation_id  CHAR(36)     NULL     COMMENT 'Correlation id of the originating request chain (== trace id); NULL if none.',
    causation_id    CHAR(36)     NULL     COMMENT 'Id of the event/command that caused this one; NULL if none.',
    thread_id       CHAR(36)     NOT NULL COMMENT 'Producing request id (AppContext.ID).',
