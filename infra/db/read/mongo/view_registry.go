...
// The registry helpers run through the backend-neutral db.Querier (the engine's
...
// db.Dialect. The framework column names are bare identifiers valid unquoted on
...
func sqlBeginRebuild(d db.Dialect) string {
...
func sqlEndRebuild(d db.Dialect) string {
	return `UPDATE omnicore_mongo_views
...
// sentinel error.
func ReadViewRegistry(ctx context.Context, q db.Querier, d db.Dialect, viewName string) (*ViewRegistryRow, error) {
...
func InitViewRegistry(ctx context.Context, q db.Querier, d db.Dialect, in InitViewRegistryInput) error {
...
func BeginRebuild(ctx context.Context, q db.Querier, d db.Dialect, viewName string, now time.Time) error {
...
func EndRebuild(ctx context.Context, q db.Querier, d db.Dialect, in EndRebuildInput) error {
...
func ListNonDone(ctx context.Context, q db.Querier) ([]ViewRegistryRow, error) {
