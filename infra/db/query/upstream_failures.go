...
// both supplied by the core.Dialect: the upsert clause (RecordUpstreamFailure builds
// it via core.Dialect.BuildUpsert — the only structurally divergent statement) and
...
func RecordUpstreamFailure(ctx context.Context, q core.Querier, d core.Dialect, rec UpstreamFailureRecord) error {
...
func ResolveUpstreamFailures(ctx context.Context, q core.Querier, d core.Dialect, subscriptionTopic, viewName, upstreamID string) error {
...
func ListPendingUpstreamFailures(ctx context.Context, q core.Querier) ([]UpstreamFailureRecord, error) {
...
func ListPendingUpstreamFailuresByTopic(ctx context.Context, q core.Querier, d core.Dialect, subscriptionTopic string) ([]UpstreamFailureRecord, error) {
...
func scanPendingUpstreamFailures(ctx context.Context, q core.Querier, query string, args ...any) ([]UpstreamFailureRecord, error) {
