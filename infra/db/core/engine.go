...
// seam that lets a relational backend (Postgres, MySQL, SQL Server, Oracle) drop
// in without the upper layers — domain, application, web — ever naming a concrete
...
// (infra/db/engine/{postgres, mysql, sqlserver, oracle}),
