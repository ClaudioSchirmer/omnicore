...
// other engines), source.col for the "set to new value" mode and a verbatim
// expression (bare column = target row, identical semantics to the other
// dialects) for the rest, terminated with the semicolon MERGE requires.
