...
// from the TableSchema (id/fk leading key + mapped columns), mirroring the auto
// scanPlan order.
...
func TestFindOne_NotFound(t *testing.T) {
	...
	l := NewAggregateLoader[*builderTestEntity](pg, func() *builderTestEntity { return &builderTestEntity{} }).
...
func TestFindRoots_NoColumnsSchema(t *testing.T) {
	...
	bare := NewTableSchema[*builderTestEntity]("bare").PK("ID", "id")
	pg := loaderPostgres(func(string, []any) (pgx.Rows, error) {
		return &fakeRows{}, nil
	})
	l := NewAggregateLoader[*builderTestEntity](pg, func() *builderTestEntity { return &builderTestEntity{} }).
...
func TestFindOne_AggregateWithChildren(t *testing.T) {
	...
	l := NewAggregateLoader[*covAgg](pg, func() *covAgg { return &covAgg{} }).
...
func TestFindOne_ManualRootScanner(t *testing.T) {
	...
	l := NewAggregateLoader[*builderTestEntity](pg, func() *builderTestEntity { return &builderTestEntity{} }).
		WithSchema(builderTestSchema).
		WithRootScanner(func(pgx.Row) (*builderTestEntity, error) {
...
func TestFindRoots_ManualScannerError(t *testing.T) {
	...
	l := NewAggregateLoader[*builderTestEntity](pg, func() *builderTestEntity { return &builderTestEntity{} }).
		WithSchema(builderTestSchema).
		WithRootScanner(func(pgx.Row) (*builderTestEntity, error) { return nil, errFake })
...
func TestHydrateChildren_ManualChildScanner(t *testing.T) {
	...
	l := NewAggregateLoader[*covAgg](pg, func() *covAgg { return &covAgg{} }).
		WithSchema(covAggSchema).
		WithChildScanner("covChild", func(pgx.Rows) (domain.AggregateValueObject, error) {
