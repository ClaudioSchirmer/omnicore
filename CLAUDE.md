...
```
go build -tags 'postgres kafka' ./...                        # an engine tag (postgres|mysql) AND a transport tag (kafka|nats) are BOTH mandatory
