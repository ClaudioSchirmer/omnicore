...
func (coreES) Translations() map[string]string {
	return map[string]string{
		...
		"UnsupportedCapabilityNotification": "Esta capacidad no es compatible con el almacén desde el que se lee esta vista.",
		...
		"MalformedIDNotification":         "El identificador del registro no es un UUID válido.",
		"UnknownIDAddressNotification":    "No existe ningún registro en esta dirección.",
		"InvalidFilterValueNotification":  "El valor del filtro no es válido para este campo.",
		...
		"TooManyRequestsNotification":             "Demasiadas solicitudes. Inténtelo de nuevo más tarde.",
		"ResourceGoneNotification":                "Este recurso ya no está disponible.",
		"PreconditionFailedNotification":          "No se cumplió una condición previa indicada en la solicitud.",
		"UnsupportedMediaTypeNotification":        "Tipo de contenido no admitido por este endpoint.",
		"NotImplementedNotification":              "Esta funcionalidad no está implementada.",
		"BadGatewayNotification":                  "Un servicio externo devolvió una respuesta no válida.",
		"PaymentRequiredNotification":             "Es necesario regularizar el pago antes de atender esta solicitud.",
		"NotAcceptableNotification":               "Ninguna representación disponible coincide con el tipo de contenido solicitado.",
		"RangeNotSatisfiableNotification":         "El intervalo solicitado no está disponible para este recurso.",
		"ResourceLockedNotification":              "Este recurso está bloqueado temporalmente. Inténtelo de nuevo en unos instantes.",
		"PreconditionRequiredNotification":        "Esta solicitud debe incluir una cabecera de condición previa.",
		"UnavailableForLegalReasonsNotification":  "Este recurso no está disponible por motivos legales.",
		"InsufficientStorageNotification":         "Se ha agotado la cuota de almacenamiento.",
		"RequestHeaderFieldsTooLargeNotification": "Las cabeceras de la solicitud superan el tamaño permitido.",
		"MalformedRequestNotification":            "No se pudo leer la solicitud.",
