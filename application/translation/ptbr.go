...
func (corePTBR) Translations() map[string]string {
	return map[string]string{
		...
		"NaturalIDImmutableNotification":    "A chave natural é imutável e não pode ser alterada.",
		...
		"PaymentRequiredNotification":             "É necessário regularizar o pagamento antes de atender esta requisição.",
		"NotAcceptableNotification":               "Nenhuma representação disponível corresponde ao tipo de conteúdo solicitado.",
		"RangeNotSatisfiableNotification":         "O intervalo solicitado não está disponível para este recurso.",
		"ResourceLockedNotification":              "Este recurso está temporariamente bloqueado. Tente novamente em instantes.",
		"PreconditionRequiredNotification":        "Esta requisição precisa conter um cabeçalho de pré-condição.",
		"UnavailableForLegalReasonsNotification":  "Este recurso está indisponível por motivos legais.",
		"InsufficientStorageNotification":         "A cota de armazenamento foi esgotada.",
		"RequestHeaderFieldsTooLargeNotification": "Os cabeçalhos da requisição excedem o tamanho permitido.",
		"MalformedRequestNotification":            "Não foi possível ler a requisição.",
